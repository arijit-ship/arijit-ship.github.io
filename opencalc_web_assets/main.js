...
function mathEval(){
 ...
 document.getElementById("expgText").innerHTML += "<br>HTML Input ==>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp" + mathHtml + "<br>";
 document.getElementById("expgText").innerText += "Text Input ==>        " + mathHtml + "\n";
